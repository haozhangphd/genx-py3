...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "genx.models.lib.sxrd_ext"
}
END: Cython Metadata */
...
#define __PYX_HAVE__genx__models__lib__sxrd_ext
#define __PYX_HAVE_API__genx__models__lib__sxrd_ext
#include <complex.h>
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(PyObject *);
...
/* Module declarations from 'genx.models.lib.sxrd_ext' */
...
#define __Pyx_MODULE_NAME "genx.models.lib.sxrd_ext"
int __pyx_module_is_main_genx__models__lib__sxrd_ext = 0;

/* Implementation of 'genx.models.lib.sxrd_ext' */
...
static const char __pyx_k_dinv[] = "dinv";
...
static const char __pyx_k_surface_lattice_sum[] = "surface_lattice_sum";
...
static const char __pyx_k_genx_models_lib_sxrd_ext[] = "genx.models.lib.sxrd_ext";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_home_hao_code_genx_genx_models[] = "/home/hao/code/genx/genx/models/lib/sxrd_ext.pyx";
...
static PyObject *__pyx_n_s_dinv;
...
static PyObject *__pyx_n_s_genx_models_lib_sxrd_ext;
...
static PyObject *__pyx_n_s_surface_lattice_sum;
...
static PyObject *__pyx_pf_4genx_6models_3lib_8sxrd_ext_surface_lattice_sum(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, __Pyx_memviewslice __pyx_v_h, __Pyx_memviewslice __pyx_v_k, __Pyx_memviewslice __pyx_v_l, __Pyx_memviewslice __pyx_v_u, __Pyx_memviewslice __pyx_v_oc, __Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_Pt, __Pyx_memviewslice __pyx_v_dinv); /* proto */
...
/* "genx/models/lib/sxrd_ext.pyx":7
...
/* Python wrapper */
static PyObject *__pyx_pw_4genx_6models_3lib_8sxrd_ext_1surface_lattice_sum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4genx_6models_3lib_8sxrd_ext_1surface_lattice_sum = {"surface_lattice_sum", (PyCFunction)__pyx_pw_4genx_6models_3lib_8sxrd_ext_1surface_lattice_sum, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4genx_6models_3lib_8sxrd_ext_1surface_lattice_sum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_memviewslice __pyx_v_oc = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_f = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_Pt = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_dinv = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("surface_lattice_sum (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_y,&__pyx_n_s_z,&__pyx_n_s_h,&__pyx_n_s_k,&__pyx_n_s_l,&__pyx_n_s_u,&__pyx_n_s_oc,&__pyx_n_s_f,&__pyx_n_s_Pt,&__pyx_n_s_dinv,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 2); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 3); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_k)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 4); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_l)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 5); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_u)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 6); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_oc)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 7); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_f)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 8); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Pt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 9); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dinv)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, 10); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "surface_lattice_sum") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0]); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1]); if (unlikely(!__pyx_v_y.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_z = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[2]); if (unlikely(!__pyx_v_z.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_h = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3]); if (unlikely(!__pyx_v_h.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_k = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[4]); if (unlikely(!__pyx_v_k.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_l = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[5]); if (unlikely(!__pyx_v_l.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_u = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[6]); if (unlikely(!__pyx_v_u.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_oc = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[7]); if (unlikely(!__pyx_v_oc.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_f = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(values[8]); if (unlikely(!__pyx_v_f.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_Pt = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(values[9]); if (unlikely(!__pyx_v_Pt.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_dinv = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[10]); if (unlikely(!__pyx_v_dinv.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("surface_lattice_sum", 1, 11, 11, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("genx.models.lib.sxrd_ext.surface_lattice_sum", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4genx_6models_3lib_8sxrd_ext_surface_lattice_sum(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_z, __pyx_v_h, __pyx_v_k, __pyx_v_l, __pyx_v_u, __pyx_v_oc, __pyx_v_f, __pyx_v_Pt, __pyx_v_dinv);
...
static PyObject *__pyx_pf_4genx_6models_3lib_8sxrd_ext_surface_lattice_sum(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, __Pyx_memviewslice __pyx_v_h, __Pyx_memviewslice __pyx_v_k, __Pyx_memviewslice __pyx_v_l, __Pyx_memviewslice __pyx_v_u, __Pyx_memviewslice __pyx_v_oc, __Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_Pt, __Pyx_memviewslice __pyx_v_dinv) {
  double __pyx_v_pi;
  ...
  __Pyx_RefNannySetupContext("surface_lattice_sum", 0);

  /* "genx/models/lib/sxrd_ext.pyx":12
 ...
 */
  __pyx_v_pi = 3.14159265358979311599796346854418516159057617187500;

  /* "genx/models/lib/sxrd_ext.pyx":14
 *     cdef double pi = 3.14159265358979311599796346854418516159057617187500
 *     cdef complex tmp
 *     cdef complex[::1] ret = np.zeros(h.shape[0], dtype=complex)             # <<<<<<<<<<<<<<
 *     cdef int i, j, m
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_h.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, ((PyObject *)(&PyComplex_Type))) < 0) __PYX_ERR(0, 14, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dc___pyx_t_double_complex(__pyx_t_4);
  if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_ret = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "genx/models/lib/sxrd_ext.pyx":18
 * 
 ...
 */
  __pyx_t_6 = (__pyx_v_h.shape[0]);
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    __pyx_v_i = __pyx_t_7;

    /* "genx/models/lib/sxrd_ext.pyx":20
 *     for i in range(h.shape[0]):
 *         # Loop over all atoms
 *         for j in range(oc.shape[0]):             # <<<<<<<<<<<<<<
 ...
 *             tmp = 0.0
 */
    __pyx_t_8 = (__pyx_v_oc.shape[0]);
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      __pyx_v_j = __pyx_t_9;

      /* "genx/models/lib/sxrd_ext.pyx":22
 *         for j in range(oc.shape[0]):
 *             #Loop over symmetry operations
 *             tmp = 0.0             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "genx/models/lib/sxrd_ext.pyx":23
 *             #Loop over symmetry operations
 *             tmp = 0.0
 *             for m in range(Pt.shape[0]):             # <<<<<<<<<<<<<<
 *                 tmp += cexp(2.0 * pi * I * (h[i] * (Pt[m, 0, 0] * x[j] + Pt[m, 0, 1]* y[j] + Pt[m, 0, 2]) +
 ...
 */
      ...
      for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        ...
        /* "genx/models/lib/sxrd_ext.pyx":24
 *             tmp = 0.0
 *             for m in range(Pt.shape[0]):
 *                 tmp += cexp(2.0 * pi * I * (h[i] * (Pt[m, 0, 0] * x[j] + Pt[m, 0, 1]* y[j] + Pt[m, 0, 2]) +             # <<<<<<<<<<<<<<
 *                                             k[i] * (Pt[m, 1, 0] * x[j] + Pt[m, 1, 1] * y[j] + Pt[m, 1, 2]) +
 ...
 */
        ...
        /* "genx/models/lib/sxrd_ext.pyx":25
 *             for m in range(Pt.shape[0]):
 *                 tmp += cexp(2.0 * pi * I * (h[i] * (Pt[m, 0, 0] * x[j] + Pt[m, 0, 1]* y[j] + Pt[m, 0, 2]) +
 *                                             k[i] * (Pt[m, 1, 0] * x[j] + Pt[m, 1, 1] * y[j] + Pt[m, 1, 2]) +             # <<<<<<<<<<<<<<
 *                                             l[i] * z[j]))
 ...
 */
        ...
        /* "genx/models/lib/sxrd_ext.pyx":26
 *                 tmp += cexp(2.0 * pi * I * (h[i] * (Pt[m, 0, 0] * x[j] + Pt[m, 0, 1]* y[j] + Pt[m, 0, 2]) +
 *                                             k[i] * (Pt[m, 1, 0] * x[j] + Pt[m, 1, 1] * y[j] + Pt[m, 1, 2]) +
 *                                             l[i] * z[j]))             # <<<<<<<<<<<<<<
 *             ret[i] += oc[j] * f[i, j] * exp(-2.0 * (pi * dinv[i])**2.0 * u[j]) * tmp
 ...
 *                                             l[i] * z[j]))
 */
        __pyx_v_tmp = __Pyx_c_sum_double(__pyx_v_tmp, cexp(__Pyx_c_prod_double(__Pyx_c_prod_double(__pyx_t_double_complex_from_parts((2.0 * __pyx_v_pi), 0), I), __pyx_t_double_complex_from_parts(((((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_h.data) + __pyx_t_12)) ))) * ((((*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Pt.data + __pyx_t_13 * __pyx_v_Pt.strides[0]) ) + __pyx_t_14 * __pyx_v_Pt.strides[1]) )) + __pyx_t_15)) ))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_x.data) + __pyx_t_16)) )))) + ((*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Pt.data + __pyx_t_17 * __pyx_v_Pt.strides[0]) ) + __pyx_t_18 * __pyx_v_Pt.strides[1]) )) + __pyx_t_19)) ))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_y.data) + __pyx_t_20)) ))))) + (*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Pt.data + __pyx_t_21 * __pyx_v_Pt.strides[0]) ) + __pyx_t_22 * __pyx_v_Pt.strides[1]) )) + __pyx_t_23)) ))))) + ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_k.data) + __pyx_t_24)) ))) * ((((*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Pt.data + __pyx_t_25 * __pyx_v_Pt.strides[0]) ) + __pyx_t_26 * __pyx_v_Pt.strides[1]) )) + __pyx_t_27)) ))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_x.data) + __pyx_t_28)) )))) + ((*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Pt.data + __pyx_t_29 * __pyx_v_Pt.strides[0]) ) + __pyx_t_30 * __pyx_v_Pt.strides[1]) )) + __pyx_t_31)) ))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_y.data) + __pyx_t_32)) ))))) + (*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Pt.data + __pyx_t_33 * __pyx_v_Pt.strides[0]) ) + __pyx_t_34 * __pyx_v_Pt.strides[1]) )) + __pyx_t_35)) )))))) + ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_l.data) + __pyx_t_36)) ))) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_z.data) + __pyx_t_37)) ))))), 0))));
      }

      /* "genx/models/lib/sxrd_ext.pyx":27
 *                                             k[i] * (Pt[m, 1, 0] * x[j] + Pt[m, 1, 1] * y[j] + Pt[m, 1, 2]) +
 *                                             l[i] * z[j]))
 *             ret[i] += oc[j] * f[i, j] * exp(-2.0 * (pi * dinv[i])**2.0 * u[j]) * tmp             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_ret.data) + __pyx_t_43)) )) += __Pyx_c_prod_double(__Pyx_c_prod_double(__Pyx_c_prod_double(__pyx_t_double_complex_from_parts((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_oc.data) + __pyx_t_38)) ))), 0), (*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_f.data) + __pyx_t_39)) ) + __pyx_t_40 * __pyx_v_f.strides[1]) )))), __pyx_t_double_complex_from_parts(exp(((-2.0 * pow((__pyx_v_pi * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_dinv.data) + __pyx_t_41)) )))), 2.0)) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_u.data) + __pyx_t_42)) ))))), 0)), __pyx_v_tmp);
    }
  }

  /* "genx/models/lib/sxrd_ext.pyx":30
 * 
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_asarray); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_ret, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = NULL;
  ...
  if (!__pyx_t_2) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_3)) {
      ...
      __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_2, __pyx_t_1};
      __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    } else
    #endif
    {
      __pyx_t_44 = PyTuple_New(1+1); if (unlikely(!__pyx_t_44)) __PYX_ERR(0, 30, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_44);
      __Pyx_GIVEREF(__pyx_t_2); PyTuple_SET_ITEM(__pyx_t_44, 0, __pyx_t_2); __pyx_t_2 = NULL;
      __Pyx_GIVEREF(__pyx_t_1);
      PyTuple_SET_ITEM(__pyx_t_44, 0+1, __pyx_t_1);
      __pyx_t_1 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_44, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_oc, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_f, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_Pt, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_dinv, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "genx.models.lib.sxrd_ext.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "genx.models.lib.sxrd_ext.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "genx.models.lib.sxrd_ext.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "genx.models.lib.sxrd_ext._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_dinv, __pyx_k_dinv, sizeof(__pyx_k_dinv), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_genx_models_lib_sxrd_ext, __pyx_k_genx_models_lib_sxrd_ext, sizeof(__pyx_k_genx_models_lib_sxrd_ext), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_surface_lattice_sum, __pyx_k_surface_lattice_sum, sizeof(__pyx_k_surface_lattice_sum), 0, 0, 1, 1},
 ...
 *                         double[::1] u, double[::1] oc, complex[::1, :] f,
 */
  __pyx_tuple__23 = PyTuple_Pack(17, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_z, __pyx_n_s_h, __pyx_n_s_k, __pyx_n_s_l, __pyx_n_s_u, __pyx_n_s_oc, __pyx_n_s_f, __pyx_n_s_Pt, __pyx_n_s_dinv, __pyx_n_s_pi, __pyx_n_s_tmp, __pyx_n_s_ret, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_m); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__23);
  __Pyx_GIVEREF(__pyx_tuple__23);
  __pyx_codeobj__24 = (PyObject*)__Pyx_PyCode_New(11, 0, 17, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__23, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_hao_code_genx_genx_models, __pyx_n_s_surface_lattice_sum, 7, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__24)) __PYX_ERR(0, 7, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initsxrd_ext(void); /*proto*/
PyMODINIT_FUNC initsxrd_ext(void)
#else
PyMODINIT_FUNC PyInit_sxrd_ext(void); /*proto*/
PyMODINIT_FUNC PyInit_sxrd_ext(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_sxrd_ext(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("sxrd_ext", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_genx__models__lib__sxrd_ext) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "genx.models.lib.sxrd_ext")) {
      if (unlikely(PyDict_SetItemString(modules, "genx.models.lib.sxrd_ext", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "genx/models/lib/sxrd_ext.pyx":2
 * include "complex.pxd"
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *                         double[::1] u, double[::1] oc, complex[::1, :] f,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4genx_6models_3lib_8sxrd_ext_1surface_lattice_sum, NULL, __pyx_n_s_genx_models_lib_sxrd_ext); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_surface_lattice_sum, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "genx/models/lib/sxrd_ext.pyx":1
 * include "complex.pxd"             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init genx.models.lib.sxrd_ext", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init genx.models.lib.sxrd_ext");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
...
/* ObjectToMemviewSlice */
          static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(PyObject *obj) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
